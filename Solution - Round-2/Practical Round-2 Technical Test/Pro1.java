...
class Pro1 {
    public static void main(String[] args) {
        ...
        // Find the largest number from the given three number and check all the
        // condition that two numbers all equals or not.
        if (n1 > n2 && n1 > n3) {
            System.out.print(n1 + " Is the greatest above them!");
        } else if (n2 > n3 && n2 > n3) {
            System.out.print(n2 + " Is the greatest above them!");
        } else if (n3 > n1 && n3 > n2) {
